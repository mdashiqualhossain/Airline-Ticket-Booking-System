...
<?php include '../View/UI.php';?>
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-10" style="text-align: center; font-size: 100px; color:#2d2244"> Akash  Airways </div>
...
<div class="col-md-10" style="text-align: center; font-size: 60px; color:#2d2244"> Add Flights </div>
			...
			<div class="col-md-10" style="text-align: center; font-size: 25px; color:#0000807">
